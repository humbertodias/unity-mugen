...
namespace UnityMugen.CustomInput
{
    ...
    public class StandaloneInputModule : PointerInputModule
    {
        ...
        [SerializeField]
        private string m_UpButton = "Horizontal";//UI_Up

        [SerializeField]
        private string m_DownButton = "Horizontal";//UI_Down

        [SerializeField]
        private string m_LeftButton = "Horizontal";//UI_Left

        [SerializeField]
        private string m_RightButton = "Horizontal";//UI_Right

        [SerializeField]
        private string m_SubmitButton = "X";//UI_Submit

        [SerializeField]
        private string m_CancelButton = "Y";//UI_Cancel
