...
namespace UnityMugen.CustomInput
{
    ...
    public class InputBinding
    {
            ...
            get
            {
                switch (m_type)
                {
                    case InputType.Button:
                        return UnityEngine.Input.GetKey(m_positive);
                    ...
                    default:
                        return Mathf.Abs(UnityEngine.Input.GetAxisRaw(m_rawAxisName)) >= 1.0f;
                }
            }
        }
        ...
        public bool AnyKey
        {
            get
            {
                return UnityEngine.Input.GetKey(m_positive) || UnityEngine.Input.GetKey(m_negative);
            }
        }
        ...
        public bool AnyKeyDown
        {
            get
            {
                return UnityEngine.Input.GetKeyDown(m_positive) || UnityEngine.Input.GetKeyDown(m_negative);
            }
        }
        ...
        public bool AnyKeyUp
        {
            get
            {
                return UnityEngine.Input.GetKeyUp(m_positive) || UnityEngine.Input.GetKeyUp(m_negative);
            }
        }
        ...
        public void Update(float deltaTime)
        {
            ...
            bool bothKeysDown = UnityEngine.Input.GetKey(m_positive) && UnityEngine.Input.GetKey(m_negative);
        ...
        {
            if (UnityEngine.Input.GetKey(m_positive))
            {
            ...
            else if (UnityEngine.Input.GetKey(m_negative))
            {
                if (m_value > AXIS_NEUTRAL && m_snap)
                {
                    m_value = AXIS_NEUTRAL;
        ...
        private void UpdateAnalogButtonValue()
        {
            float axis = m_type == InputType.AnalogButton ?
                                    UnityEngine.Input.GetAxis(m_rawAxisName) :
        ...
        public float? GetAxis()
        {
            ...
            else if (m_type == InputType.MouseAxis)
            {
                ...
                {
                    axis = UnityEngine.Input.GetAxis(m_rawAxisName) * m_sensitivity;
                    axis = m_invert ? -axis : axis;
                }
            }
            else if (m_type == InputType.AnalogAxis)
            {
                if (m_rawAxisName != null)
                {
                    axis = UnityEngine.Input.GetAxis(m_rawAxisName);
        ...
        public float? GetAxisRaw()
        {
            ...
            else if (m_type == InputType.MouseAxis || m_type == InputType.AnalogAxis)
            {
                if (m_rawAxisName != null)
                {
                    axis = UnityEngine.Input.GetAxisRaw(m_rawAxisName);
                    axis = m_invert ? -axis : axis;
                }
            }
            else if (m_type == InputType.GamepadAxis)
        ...
        public bool? GetButton()
        {
            ...
            {
                value = UnityEngine.Input.GetKey(m_positive);
            }
        ...
        public bool? GetButtonDown()
        {
            ...
            if (m_type == InputType.Button)
            {
                value = UnityEngine.Input.GetKeyDown(m_positive);
            }
            else if (m_type == InputType.GamepadButton)
            {
        ...
        public bool? GetButtonUp()
        {
            ...
            if (m_type == InputType.Button)
            {
                value = UnityEngine.Input.GetKeyUp(m_positive);
            }
            else if (m_type == InputType.GamepadButton)
            {
