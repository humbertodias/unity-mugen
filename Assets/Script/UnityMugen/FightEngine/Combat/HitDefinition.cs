...
namespace UnityMugen.Combat
{
    ...
    public class HitDefinition
    {
        ...
        public HitDefinition(HitDefinition hitDefinition)
        {
            Set(hitDefinition);
        }
        ...
        public float GuardShakeTime { get; set; }
        ...
        public Vector2? MininumDistance { get; set; }
        public Vector2? MaximumDistance { get; set; }
        public Vector2? SnapLocation { get; set; }
        ...
        public float NoChainId1 { get; set; }
        public float NoChainId2 { get; set; }
        ...
        public float P1HitPowerAdjustment { get; set; }
        public float P1GuardPowerAdjustment { get; set; }
        public float P2HitPowerAdjustment { get; set; }
        public float P2GuardPowerAdjustment { get; set; }
