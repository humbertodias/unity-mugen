...
namespace UnityMugen.Combat
{
    ...
    public class HitPriority : IEquatable<HitPriority>
    {
        static HitPriority()
        {
        ...
        public HitPriority(int power)
        {
            m_type = PriorityType.Hit;
            m_power = power;
        }

        public HitPriority(PriorityType typ)
        {
            m_type = typ;
            m_power = 4;
        }

        public HitPriority(int power, PriorityType type)
        {
            m_type = type;
            m_power = power;
        }
