...
namespace UnityMugen.Evaluation
{
    ...
    public struct Number : IEquatable<Number>
    {
        ...
        public static Number operator !(Number number) // OK
        {
        ...
        public static Number operator ==(Number lhs, Number rhs) // OK
        {
        ...
        public static Number LogicalNot(Number input) // OK
        {
            return input.NumberType == NumberType.None ? new Number() : new Number(!input.BooleanValue);
        }

        public static Number BinaryNot(Number input) // OK
        {
