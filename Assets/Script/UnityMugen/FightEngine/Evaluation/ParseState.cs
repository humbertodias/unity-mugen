...
namespace UnityMugen.Evaluation
{
    ...
    public class ParseState
    {
        ...
        {
            return LauncherEngine.Inst.stringConverter.Convert<T>(CurrentUnknown);
        }
        ...
        public Token NextToken => m_currentindex >= 0 && (m_currentindex + 1) < m_tokens.Count ? m_tokens[m_currentindex+1] : null;
