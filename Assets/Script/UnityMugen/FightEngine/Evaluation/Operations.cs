...
namespace UnityMugen.Evaluation.Operations
{
    class Null : Function
    {
    ...
    class Assignment : Function
    {
        ...
        public override Number Evaluate(Character state)
        {
            ...
            if (varfunc is Triggers.Var)
            {
                ...
                if (state.Variables.SetInteger(varindex.IntValue, false, result.IntValue) == false)
                {
                    return new Number();
                }
            }
            else if (varfunc is Triggers.FVar)
            {
                ...
                if (state.Variables.SetFloat(varindex.IntValue, false, result.FloatValue) == false)
                {
                    return new Number();
                }
            }
            else if (varfunc is Triggers.SysVar)
            {
                ...
                if (state.Variables.SetInteger(varindex.IntValue, true, result.IntValue) == false)
                {
                    return new Number();
                }
            }
            else if (varfunc is Triggers.SysFVar)
            {
                ...
                if (state.Variables.SetFloat(varindex.IntValue, true, result.FloatValue) == false)
                {
                    return new Number();
                }
            }
