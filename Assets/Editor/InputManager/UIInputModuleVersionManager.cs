...
namespace UnityMugen.CustomInput
{
    public class UIInputModuleVersionManager : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Current Version: Unity " + StandaloneInputModule.VERSION);
        ...
        [MenuItem("UnityMugen/Input Manager/Set Input Module Version", false, 200)]
        public static void Open()
        {
            EditorWindow.GetWindow<UIInputModuleVersionManager>("Module Version");
        }

        [MenuItem("UnityMugen/Input Manager/Use Custom Input Module", false, 201)]
