...
public class ImporterSffEditorWindow : EditorWindow
{
    ...
    static void Init()
    {
        EditorWindow.GetWindow(typeof(ImporterSffEditorWindow)).Show();
    ...
    void DirectorySave()
    {
        ...
        {
            PathSaveSprites = Application.dataPath + "/0_Extracts/Sprites/";
        }
    }
    ...
    void OnGUI()
    {
        ...
        EditorGUILayout.LabelField("Converter Sff V1 para V2.");
        ...
        EditorGUILayout.LabelField("Antes de Converter Sff V1 para V2. desabilitar ", gs);
        EditorGUILayout.LabelField("todas as paletas antes de salvar o arquivo.", gs);
